...
Si la sesión se corta, agrega el último artefacto como input, descomprímelo sobre la misma ruta de salida y vuelve a ejecutar. El flag `--resume` restaura el último estado de modelo y optimizador.
