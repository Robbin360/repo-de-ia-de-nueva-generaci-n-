# =============================================================================
# CELDA 10 — D1C V3-R1: retry aislado con perfil de release, variante habilitable
# Propósito: preparar un único experimento nuevo desde inicialización nueva.
# Esta plantilla local conserva seis puertas cerradas y no debe ejecutarse.
# =============================================================================
...
# Seis puertas finales, deliberadamente cerradas. La sexta separa el perfil
# de release V3-R1 de la autorización de una corrida general.
...
print("CELDA 10 — D1C V3-R1: retry aislado con perfil de release, variante habilitable")
...
if pending_values != approved_values:
    print("D1C_V3_R1_CELL_PREPARED_NOT_EXECUTED")
    print("D1C_V3_R1_RETRY_PENDING_FINAL_AUTHORIZATION")
    print(
        "D1C V3-R1 permanece bloqueada: no se seleccionó GPU, no se leyó Dataset train/holdout, "
    ...
    # Sólo se alcanza tras seis confirmaciones inmediatas y separadas.
